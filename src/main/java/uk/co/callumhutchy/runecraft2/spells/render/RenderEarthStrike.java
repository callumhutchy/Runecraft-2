...
public class RenderEarthStrike extends Render  {
	private StrikeModel						model;

	public final ResourceLocation	earthstrikeTextures	= new ResourceLocation("runecraft2:textures/entity/EarthStrikeTexture.png");
	

	public RenderEarthStrike(RenderManager renderManager) {
		super(renderManager);
	...
	public void doRender(Entity entity, double x, double y, double z, float rx, float ry) {
		...
		// bind your texture:
		bindTexture(earthstrikeTextures);
