...
public class GuiSpellBook extends GuiScreen {
    ...
    public boolean airstrikeselected, hometeleportselected, waterstrikeselected, earthstrikeselected, firestrikeselected, earthpillarselected = false;
	...
	if (fsminx < varx && varx < fsmaxx && fsminy < vary && vary < fsmaxy) {
	    this.DrawTooltipScreen(varx, vary, "_lFire Strike:_r _p" + "1x Fire Rune _p" + "Fires a weak bolt of fire.");
	}
	if (esminx < varx && varx < esmaxx && esminy < vary && vary < esmaxy) {
	    this.DrawTooltipScreen(varx, vary, "_lEarth Strike:_r _p" + "1x Earth Rune _p" + "Fires a weak bolt of earth.");
	}
	if (epminx < varx && varx < epmaxx && epminy < vary && vary < epmaxy) {
	    this.DrawTooltipScreen(varx, vary, "_lEarth Pillar:_r _p" + "1x Water Rune _p" + "Fires a weak bolt of water.");
	}
