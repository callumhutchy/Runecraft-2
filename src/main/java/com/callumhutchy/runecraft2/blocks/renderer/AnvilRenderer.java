...
import com.callumhutchy.runecraft2.blocks.models.AnvilModel;
...
private AnvilModel model;

    
    public String ResourceLocationvar = "runecraft2:textures/blocks/AnvilTexture.png";
    
    
    public AnvilRenderer() {
       
    	this.model = new AnvilModel();
