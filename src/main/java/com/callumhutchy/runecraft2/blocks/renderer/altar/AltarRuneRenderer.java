package com.callumhutchy.runecraft2.blocks.renderer.altar;
...
public class AltarRuneRenderer extends TileEntitySpecialRenderer{

	private AltarRuneModel model;

    
    public String ResourceLocationvar;
    
    
    public AltarRuneRenderer(String resourceLocation) {
       
    	this.model = new AltarRuneModel();
