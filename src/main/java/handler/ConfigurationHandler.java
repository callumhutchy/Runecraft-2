...
public class ConfigurationHandler {
	...
	private static void loadConfiguration(){
		altarWorldGen = configuration.getBoolean("Altar World Gen", Configuration.CATEGORY_GENERAL, true, "Whether the Altar world gens should be generated.");
		oreWorldGen = configuration.getBoolean("Ore World Gen", Configuration.CATEGORY_GENERAL, true, "Whether the Ore world gens should be generated.");
